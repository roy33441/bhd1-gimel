...
const TzoerSettings: FC = (): any => {
  ...
  const [
    addTzoerArray,
    { data: addTzoerData, loading: addTzoerLoading, error: addTzoerError },
          ...
          <Drawer anchor="bottom" open={open} onClose={toggleDrawer}>
            <div>
              <div className={classes.paperDrawer}>
                  ...
                  <div>
                    ...
                    <div className={classes.infoContainer}>
                      ...
                      <Link
                        ...
                        to="/bhd1-gimel/files/תבנית_להוספת_צוערים.xlsx"
                        target="_blank"
                        download
                      >
                        תלחצו ממש כאן
                    ...
                    <div className={classes.importContainer}>
                      ...
                      <label htmlFor="button-file">
                        ...
                        >
                          <Typography className={classes.buttontitel}>
                            {" "}
                            לכאן גוררים קובץ אקסל{" "}
                          </Typography>
                        </Button>
                      </label>
                    </div>
                ...
                <div>
                  <div className={classes.importContainer}>
                    <Typography className={classes.resetTitel}>
                      מחזור חדש? כדאי לאפס את הצוערים!
                    </Typography>
                  </div>
                  <div className={classes.importContainer}>
                    <Button
                ...
                {openReset ? (
                  <div>
                    <div className={classes.importContainer}>
                      <InfoOutlinedIcon color="primary" />
                      <Typography className={classes.infoTitle}>
                        שים לב! פעולה זו תאפס את כל הצוערים!
                      </Typography>
                    </div>
                    <div className={classes.importContainer}>
                      <Button
